...
#Load spectrum and regulation data.  Single_DD0_v1.csv for initial model.  Single_Strict_v1.csv for strict model.
dader <- read.csv("Single_Strict_v1.csv", header = TRUE)
