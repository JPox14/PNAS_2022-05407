function dydt = LVfunc_Ex_Soak(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,HCE)
...
%Invader Toxin
    dydt(7) =ci*y(3)*(y(8)/(y(8)+Kn1)) - ((y7 + y7I)) - y(3)*gamD*(y(7)^HCE/(y(7)^HCE+Km^HCE));
%Resident Toxin
    dydt(6) = cr*y(2)*(y(8)/(y(8)+Kn1)) - ((y6 + y6r)) - y(2)*gamD*(y(6)^HCE/(y(6)^HCE+Km^HCE));
%Niche Competitor Toxin
    dydt(5) = cS*y(1)*(y(8)/(y(8)+Kn1)) - ((y52 + y53 + y5s)) - y(1)*gamD*(y(5)^HCE/(y(5)^HCE+Km^HCE));
