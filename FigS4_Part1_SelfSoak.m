...
E = 15;
Emod = 0.1;       %What happens if we relax the assumption that binding leads to killing for non-target species?
    ...
    gc = 0;
        ...
        for GamRi = GamRi0:gi:GamRiF
            ...
            for GamRS = GamRs0:gr:GamRsF
                ...
                ci = GamRi; 
                cS = GamRS;
                eventfunc = @(t,y) steadystateNutEx_SelfSoak(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,DEG,HCE);
                optionsode=odeset('Events',eventfunc,'NonNegative',1:9);
                if DEG == 1
                    [t,y,te,ye,ie] = ode45(@(t,y) LVfunc_Ex_Soak(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,HCE),tspan, y0,optionsode);
                else
...
save('C:\Users\jdpal\Desktop\Local\PNAS_Revisions\Data\Fig3_SelfSoak','eCelery')
